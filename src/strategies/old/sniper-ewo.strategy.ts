...
export class SniperEwoStrategy extends BaseStrategy {
    ...
    async advice() {
        ...
        const buyCandle =
            this.alternateTimeFrameCandle?.candlesticks[
                this.alternateTimeFrameCandle.candlesticks.length - 1
            ];
    ...
    logStatus(advice: any): void {
        ...
        let canTrade = `EWO: ${this.ewo.result}. CCI: ${this.sniperCCI} - READY? ${
            this.canTrade ? 'OK' : 'NO'
        }`;
